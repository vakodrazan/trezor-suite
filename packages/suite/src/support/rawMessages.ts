const messages = {
    ...
    TR_BACKUP_SUBHEADING_1: {
        defaultMessage: "Your Trezor will generate a list of words which you need to write down. This information is the most important part of securing your Trezor: it is the only offline backup of your Trezor and all wallets associated with it.",
    ...
    TR_BCH_ADDRESS_INFO: {
        defaultMessage: "Bitcoin Cash changed the format of addresses to cashaddr. Find more info about how to convert your address on our blog. {TR_LEARN_MORE}",
    ...
    TR_BRIDGE_SUBHEADING: {
        defaultMessage: "Trezor Bridge facilitates the connection between your Trezor and your internet browser.",
    ...
    TR_CHOOSE_BETWEEN_NO_PASSPHRASE: {
        defaultMessage: "Access either Standard wallet with no passphrase or Hidden wallet with a passphrase.",
    ...
    TR_CONNECTED_DEVICE_IS_IN_BOOTLOADER: {
        defaultMessage: "This Trezor is in bootloader mode. Disconnect your Trezor, then reconnect it to continue the setup process.",
    ...
    TR_DEVICE_DISCONNECTED_DURING_ACTION_DESCRIPTION: {
        defaultMessage: "Your Trezor was disconnected during the backup process. We strongly recommend that you use the factory reset option in the Suite settings to wipe your device and start the wallet backup process again.\n",
    ...
    TR_DEVICE_IS_USED_IN_OTHER_WINDOW_TEXT: {
        defaultMessage: "Your Trezor seems to be in use in another window. Please close all other windows or tabs that might be using your Trezor.",
        description: "",
    ...
    TR_DEVICE_NOT_RECOGNIZED_TRY_UDEV: {
        defaultMessage: "Trezor not recognized? Try installing {link}. Make sure to first download them to desktop before opening.",
    ...
    TR_UDEV_DOWNLOAD_DESC: {
        defaultMessage: "In some cases, Linux users need to install udev rules to access their device. Please install the following package and reconnect your Trezor.",
    ...
    TR_DEVICE_SETTINGS_CUSTOM_FIRMWARE_DESCRIPTION: {
        defaultMessage: "It is possible to install custom firmware for your Trezor device if needed. Installing custom firmware will erase its memory and may make it unusable. Never use this process unless you really know what you are doing.",
    ...
    TR_DEVICE_SETTINGS_PASSPHRASE_DESC_MORE: {
        defaultMessage: "Do not forget your passphrase. Unlike everyday passwords, hidden wallet passphrases cannot be retrieved and your funds will be permanently lost.",
    ...
    TR_DEVICE_SETTINGS_SAFETY_CHECKS_DESC: {
        defaultMessage: "Safety checks protect you from performing non-standard transactions. They can be temporarily disabled in case such a transaction needs to be carried out.",
    ...
    TR_SAFETY_CHECKS_PROMPT_LEVEL_DESC: {
        defaultMessage: "Allow potentially unsafe actions, such as mismatching coin keys or extreme fees by manually approving them on your Trezor.",
    ...
    TR_DEVICE_SETTINGS_PIN_PROTECTION_DESC: {
        defaultMessage: "Setting a strong PIN is one of the main ways to secure your device against unauthorized physical access and protect your funds.",
    ...
    TR_DEVICE_SETTINGS_CHANGE_PIN_DESC: {
        defaultMessage: "If your PIN has been exposed or you simply want to change it, you can reset it here. You can change your PIN as often as you like.",
    ...
    TR_ENTER_SEED_WORDS_INSTRUCTION: {
        defaultMessage: "Enter the words from your seed here in the order displayed on your device. ",
        description: "User is instructed to enter words from seed (backup) into the form in browser",
    ...
    TR_FIRMWARE_SUBHEADING: {
        defaultMessage: "Your Trezor is shipped without any firmware, so you can install the latest version directly by clicking the button below. When your device starts up, it will confirm that the firmware is authentic or display a warning.",
    ...
    TR_CONTINUE_TO_PIN: {
        ...
        description: "Button in standalone backup page that will direct user to setting up pin (in case it is not set up yet).",
    ...
    TR_HELP_TREZOR_SUITE_TEXT_1: {
        defaultMessage: "Help Suite become a better product by sharing your {TR_HELP_TREZOR_SUITE_TEXT_1_FAT}.",
    ...
    TR_HELP_TREZOR_SUITE_TEXT_2: {
        defaultMessage: "All data is kept strictly anonymous; we only use it to improve the Trezor ecosystem.",
    ...
    TR_ONBOARDING_DATA_COLLECTION_DESCRIPTION: {
        ...
        defaultMessage: "All data is anonymous and is used only for product development purposes. Read more in <a>Terms & Conditions</a>."
    },
    ...
    TR_INSTRUCTION_TO_SKIP: {
        defaultMessage: "You should skip setup and continue to wallet and check if you have any funds on this device.",
        description: "Instruction what to do when user knows the device he is holding was manipulated by him, not someone else.",
    ...
    TR_IS_NOT_NEW_DEVICE: {
        defaultMessage: "You indicated that you haven't used this Trezor. However, we've detected pre-installed firmware; this could put your funds at risk. If you didn't install this firmware, contact Trezor support.",
        description: "Just a message that we show after user selects that he wants to setup device as a new one but we detect that it apparently is not",
    ...
    TR_LTC_ADDRESS_INFO: {
        defaultMessage: "Litecoin changed the format of addresses. Find more info about how to convert your address on our blog. {TR_LEARN_MORE}",
    ...
    TR_NAV_SIGN_AND_VERIFY: {
        ...
        description: "Title of the navigation tab that contains a form for signing and verifying messages",
    ...
    TR_NUM_ACCOUNTS_FIAT_VALUE: {
        defaultMessage: "{accountsCount} {accountsCount, plural, one {account} other {accounts}} • {fiatValue}",
    ...
    TR_PIN_SET_SUCCESS: {
        defaultMessage: "Write your PIN down and keep it safe, separate from your recovery seed. Use it to unlock your Trezor when you need to access your funds.",
        description: "Longer text indicating PIN was set successfully.",
        id: "TR_PIN_SET_SUCCESS"
    },
    TR_PIN_SUBHEADING: {
        defaultMessage: "Using a strong PIN protects your Trezor from unauthorized physical access.",
    ...
    TR_RANDOM_SEED_WORDS_DISCLAIMER: {
        defaultMessage: " You may be asked to type some words that are not part of your recovery seed.",
        description: "User is instructed to enter words from seed (backup) into the form in browser",
    ...
    TR_BECH32_BANNER_POINT_1: {
        defaultMessage: "Lowercase letters only = <strong>lower chance of any reviewing errors</strong>",
        id: "TR_BECH32_BANNER_POINT_1"
    },
    TR_BECH32_BANNER_POINT_2: {
        defaultMessage: "Efficient technology = <strong>pay up to 25% lower transactions fees</strong>",
    ...
    TR_RECOVER_SUBHEADING: {
        defaultMessage: "If you want to recover an existing wallet, you can do so with your recovery seed. Select the number of words in your recovery seed.",
        description: "Subheading in recover page. Basic info about recovery",
        id: "TR_RECOVER_SUBHEADING"
    },
    TR_RECOVER_SUBHEADING_MODEL_T: {
        defaultMessage: "Using a Trezor Model T, the entire recovery process is done on the device's touchscreen.",
        description: "Subheading in recover page. Basic info about recovery",
    ...
    TR_RECOVERY_SEED_IS: {
        defaultMessage: "The process of creating a list of words in a specific order which store all the information needed to recover a wallet.",
    ...
    TR_RECOVERY_TYPES_DESCRIPTION: {
        defaultMessage: "Both methods are secure; advanced recovery allows you to input your recovery seed using your Trezor screen and takes slightly longer.",
    ...
    TR_REMEMBER_ALLOWS_YOU_TO: {
        defaultMessage: "Stores wallet for a watch-only mode: You will see your wallet even if device is disconnected.\n",
    ...
    TR_SECURITY_SUBHEADING: {
        defaultMessage: "You've successfully set up your Trezor and created your wallet. You should never use your Trezor without backing it up; it is the only way to recover a lost wallet.",
    ...
    TR_SKIP_ONBOARDING_TEXT: {
        defaultMessage: "If your Trezor is already set up and you have used the Trezor web interface or Suite before, that's great! Only continue if you set up your Trezor yourself; your funds may be at risk if someone else did it.",
    ...
    TR_TESTNET_COINS_EXPLAINED: {
        defaultMessage: "Testnet coins have no monetary value. They are tools to experiment with various features of Trezor Suite without risk. ",
    ...
    TR_THIS_HIDDEN_WALLET_IS_EMPTY: {
        defaultMessage: "This hidden wallet is empty. To make sure you are in the correct hidden wallet, please type the passphrase again.",
        id: "TR_THIS_HIDDEN_WALLET_IS_EMPTY"
    },
    TR_THIS_HIDDEN_WALLET_IS_EMPTY_SOURCE: {
        defaultMessage: "This hidden wallet is empty. To make sure you are in the correct hidden wallet, please type again the passphrase on Trezor.",
    ...
    TR_TO_PREVENT_PHISHING_ATTACKS_COMMA: {
        defaultMessage: "To prevent phishing attacks, you should verify the address on your Trezor. {claim}",
    ...
    TR_WIPING_YOUR_DEVICE: {
        defaultMessage: "This removes all of this Trezor's memory, including its seed. Only wipe your device if you have your recovery seed on hand or there are no funds stored on this device.",
    ...
    TR_XRP_RESERVE_INFO: {
        defaultMessage: "Ripple addresses require a minimum balance of {minBalance} XRP to activate and maintain the account.",
    ...
    TR_SEND_GAS_LIMIT_TOOLTIP: {
        ...
        defaultMessage: "Gas limit refers to the maximum amount of gas user is willing to spend on a particular transaction. Transaction fee = gas limit * gas price. Increasing the gas limit will not get the transaction confirmed sooner. Default value for sending ETH is {defaultGasLimit}"
    },
    ...
    TR_ACCOUNT_DETAILS_TYPE_BECH32: {
        ...
        defaultMessage: "Bech32 uses the most modern addresses for smallest transaction fees. Be aware that it may not be compatible with old services."
    },
    ...
    TR_ACCOUNT_DETAILS_TYPE_P2PKH: {
        ...
        defaultMessage: "Legacy Pay-to-Public-Key-Hash (P2PKH) is the basic type of transaction used in Bitcoin and other similar crypto currencies."
    },
    ...
    TR_ACCOUNT_DETAILS_XPUB: {
        ...
        defaultMessage: "Handle your account public key (xPUB) carefully. When exposed, a third party will be able to see your entire transaction history."
    },
    ...
    TR_TOR_DESCRIPTION: {
        ...
        defaultMessage: "Enabling this will route all of Suite's traffic through the Tor network.{lineBreak}All requests to Trezor infrastructure will be pointed to our Tor services, increasing your privacy and security."
    },
    ...
    TR_ONION_LINKS_DESCRIPTION: {
        ...
        defaultMessage: "With this setting enabled, all trezor.io links will be opened as .onion links."
    },
    TR_TOR_PARAM_TITLE: {
    ...
    TR_TOR_PARAM_DESCRIPTION: {
        ...
        defaultMessage: "You can configure the address to point to a different Tor instance. Default: 127.0.0.1:9050."
    },
    TR_TOR_BRIDGE: {
        id: "TR_TOR_BRIDGE",
    ...
    TR_OUTDATED_BRIDGE_DESKTOP: {
        ...
        defaultMessage: "The Trezor Suite application comes with Trezor Bridge bundled. If you only use the Trezor Suite application, we recommend you to uninstall Trezor Bridge in order to use the bundled one. If you are using Trezor in your browser as well, updating Trezor Bridge is recommended."
    },
    ...
    TR_WIPE_DEVICE_TEXT: {
        ...
        defaultMessage: "Reseting the device removes all its data. Reset your device only if you have recovery seed or there are no funds stored on the device."
    },
    ...
    TR_WIPE_DEVICE_CHECKBOX_1_DESCRIPTION: {
        ...
        defaultMessage: "All data associated with the pre-existing accounts will be deleted. You will need a recovery seed to recover your wallet."
    },
    ...
    TR_WIPE_DEVICE_CHECKBOX_2_DESCRIPTION: {
        ...
        defaultMessage: "Your assets are safe only provided you have created a recovery seed. Make sure you have your seed or you know where you keep it."
    },
    TR_CANCEL: {
        id: "TR_CANCEL",
    ...
    TR_ADVANCED_RECOVERY_TEXT: {
        ...
        defaultMessage: "Spell each word of your recovery seed using the keypad below, according to where the letters are shown on your Trezor screen."
    },
    ...
    TR_CHECK_RECOVERY_SEED_DESC_T1: {
        ...
        defaultMessage: "Enter the words from your seed here in the order displayed on your device. You may be asked to type some words that are not part of your recovery seed as an additional security measure."
    },
    ...
    TR_CHECK_RECOVERY_SEED_DESC_T2: {
        ...
        defaultMessage: "Your wallet backup, the recovery seed, is entered entirely on the Trezor Model T, through the device screen. We avoid passing any of your sensitive information to a potentially insecure computer or web browser."
    },
    TR_USING_TOUCHSCREEN: {
        id: "TR_USING_TOUCHSCREEN",
        defaultMessage: "Using the touchscreen display, enter all the words in the correct order until completed."
    },
    ...
    TR_ALL_THE_WORDS: {
        id: "TR_ALL_THE_WORDS",
        defaultMessage: "The words are entered always on the device for security reasons. Please enter all the words in the correct order."
    },
    ...
    TR_SEED_CHECK_SUCCESS_DESC: {
        ...
        defaultMessage: "Your seed is valid and has just been successfully checked. Please take great care of it and/or hide it back where you are going to find it."
    },
    ...
    TR_WORD_DOES_NOT_EXIST: {
        ...
        description: "In recovery or dry run, appears when user types a string that is not a substring of any word included in bip39 word list."
    },
    TR_BACKSPACE: {
        id: "TR_BACKSPACE",
    ...
    TR_DRY_RUN_CHECK_ITEM_DESCRIPTION: {
        ...
        defaultMessage: "Note that this test is precisely the same as the normal recovery process. You should only trust the information and instructions displayed on your Trezor screen."
    },
    TR_WHAT_IS_DRY_RUN: {
    ...
    FW_CAPABILITY_NO_SUPPORT: {
        ...
        defaultMessage: "Not supported",
        description: "Similar to missing capability but tested on different level (coin info is missing in trezor-connect)"
    },
    ...
    MODAL_ADD_ACCOUNT_DESC: {
        ...
        defaultMessage: "Group transactions using addresses that belong to a particular account. Please note that 1500+ supported ERC20 tokens reside on the ETH network (Accounts › ETH Account › Tokens). All supported cryptocurrencies:  {trezorCoinsUrl} "
    },
    ...
    TR_MODELS_DESC: {
        id: "TR_MODELS_DESC",
        defaultMessage: "Trezor One features two buttons and a monochromatic screen, Trezor T is the high-end model featuring touch-screen display."
    },
    ...
    TR_CLEAR_STORAGE_DESCRIPTION: {
        ...
        defaultMessage: "Resetting the app restores it to its default settings; this is a good first step to any troubleshooting. The app will restart itself at the end of the process."
    },
    TR_CHOOSE_WALLET: {
        id: "TR_CHOOSE_WALLET",
    ...
    RECEIVE_DESC_BITCOIN: {
        ...
        defaultMessage: "To receive any funds you need to get a fresh receive address. It is advised to always use a fresh one as this prevents anyone else to track your transactions. You can reuse an address but we recommend not doing it unless it is necessary."
    },
    ...
    TR_BUY_RECEIVE_ACCOUNT_QUESTION_TOOLTIP: {
        ...
        defaultMessage: "This is the account within your wallet where you'll find your coins once the transaction is finished."
    },
    TR_BUY_RECEIVE_ADDRESS_QUESTION_TOOLTIP: {
        id: "TR_BUY_RECEIVE_ADDRESS_QUESTION_TOOLTIP",
        defaultMessage: "This is the specific alphanumeric address that will receive your coins. Verify this address on your Trezor."
    },
    ...
    TR_OFFER_FEE_INFO: {
        ...
        defaultMessage: "The amount shown is the final amount you'll receive, with provider exchange fees included. However, your bank may charge additional currency exchange fees if your bank account is not denominated in the chosen currency."
    },
    TR_SHOW_BUTTON: {
        id: "TR_SHOW_BUTTON",
        defaultMessage: "Show"
    ...
    TR_FULL_LABEL: {
        ...
        description: "Meant as a label. Used for example in firmware update when indicating which type of firmware version is the new one."
    },
    ...
    TR_BEFORE_ANY_FURTHER_ACTIONS: {
        ...
        defaultMessage: "Before you perform the update, please make sure you have your recovery seed."
    },
    ...
    TR_COULD_NOT_RETRIEVE_DATA_FOR: {
        ...
        defaultMessage: " * Could not retrieve data for {accountsCount} {accountsCount, plural, one {account} other {accounts}}"
    },
    TR_HELP: {
        id: "TR_HELP",
        defaultMessage: "Support"
    ...
    TR_DISABLE_WEBUSB_TRY_BRIDGE: {
        ...
        describe: "Bridge is a communication deamon that some users will need to download and install. So word bridge should not be translated."
    },
    TR_YOUR_DEVICE_IS_SEEDLESS: {
        id: "TR_YOUR_DEVICE_IS_SEEDLESS",
        defaultMessage: "Your device is in seedless mode and is not allowed to be used with this wallet."
    },
    TR_YOUR_DEVICE_IS_CONNECTED_BUT_UNREADABLE: {
        id: "TR_YOUR_DEVICE_IS_CONNECTED_BUT_UNREADABLE",
        defaultMessage: "Your device is connected properly, but your internet browser can not communicate with it at the moment. You will need to install Trezor Bridge."
    },
    TR_RESOLVE: {
        id: "TR_RESOLVE",
    ...
    TR_DEVICE_NOT_INITIALIZED: {
        ...
        description: "Device not initialized means that it has no cryptographic secret lives in it and it must be either recovered from seed or newly generated."
    },
    ...
    TR_SEEDLESS_MODE: {
        ...
        description: "Seedless is a term. It means that device has cryptographic secret inside but has never given out recovery seed"
    },
    TR_SEEDLESS_MODE_EXPLAINED: {
        id: "TR_SEEDLESS_MODE_EXPLAINED",
        defaultMessage: "Seedless mode means that device has cryptographic secret inside but no corresponding recovery seed exists. Such devices are not allowed to be used with this wallet."
    },
    TR_UNKNOWN_DEVICE: {
    ...
    TR_UNREADABLE_EXPLAINED: {
        ...
        defaultMessage: "We cant see details about your device. It might be Trezor with old firmware or possibly any USB device. To make communication possible, you will need to install Trezor Bridge."
    },
    TR_SEE_DETAILS: {
        id: "TR_SEE_DETAILS",
    ...
    TR_FIRMWARE_UPDATE_REQUIRED_EXPLAINED: {
        ...
        defaultMessage: "Your device has firmware that is no longer supported. You will need to update it."
    },
    ...
    TR_DEVICE_IN_BOOTLOADER_EXPLAINED: {
        ...
        defaultMessage: "In bootloader mode, device is ready to receive firmware updates but it also means that nothing else might be done with it. To get back into normal mode simply reconnect it."
    },
    ...
    TR_ONCE_YOU_BEGIN_THIS_PROCESS: {
        ...
        defaultMessage: "This process only takes a few minutes, but you can't pause or restart it once you begin."
    },
    ...
    TR_MAKE_SURE_NO_ONE_CAN_PEEK: {
        ...
        defaultMessage: "Make sure no one can peek over your shoulder and no cameras can see your screen. No one should ever see your backup except you."
    },
    ...
    TR_BACKUP_SEED_IS_ULTIMATE: {
        ...
        defaultMessage: "Your recovery seed is the key to your wallet and funds. If you lose it, it's gone forever: there is no other way to restore a lost wallet."
    },
    ...
    DESKTOP_OUTDATED_MESSAGE: {
        ...
        defaultMessage: "Your version {currentVersion} does not match the latest version from GitHub {newVersion}"
    },
    ...
    TR_FIRMWARE_IS_POTENTIALLY_RISKY: {
        ...
        defaultMessage: "Updating firmware is potentially risky operation. If anything goes wrong (broken cable etc.) device might end up in wiped state which effectively means losing all your coins."
    },
    ONBOARDING_PAIR_ALREADY_INITIALIZED: {
        id: "ONBOARDING_PAIR_ALREADY_INITIALIZED",
        defaultMessage: "Only continue if you performed the setup yourself. If someone else set up your Trezor, your funds could be at risk; <a>contact Trezor support</a>."
    },
    ...
    ONBOARDING_UNEXPECTED_DEVICE_DIFFERENT_P1: {
        ...
        defaultMessage: "This isn't the same Trezor you've been using. Please reconnect the right one.\n"
    },
    ...
    TR_PAIR_YOUR_TREZOR: {
        ...
        description: "After firmware update is done, user must renew connection with Trezor device. We also call this \"pairing\" device"
    },
    ...
    TR_ONBOARDING_GENERATE_SEED: {
        ...
        description: "Used for button triggering seed creation (reset device call), user chooses between single seed and shamir"
    },
    TR_ONBOARDING_GENERATE_SEED_DESCRIPTION: {
        id: "TR_ONBOARDING_GENERATE_SEED_DESCRIPTION",
        defaultMessage: "Choose how to back up your Trezor. This process will also create a standard wallet for you.",
        description: "Used for button triggering seed creation (reset device call), user chooses between single seed and shamir"
    },
    TR_CREATE_WALLET: {
        id: "TR_CREATE_WALLET",
        defaultMessage: "Create new wallet",
        description: "Used for button triggering seed creation (reset device call) if shamir/non-shamir selection is not available."
    },
    TR_YOU_MAY_CHOSE_EITHER_STANDARD: {
        id: "TR_YOU_MAY_CHOSE_EITHER_STANDARD",
        defaultMessage: "New wallets are created based on the type of recovery seed you use to back up your wallet."
    },
    SINGLE_SEED: {
        id: "SINGLE_SEED",
    ...
    SHAMIR_SEED_DESCRIPTION: {
        ...
        defaultMessage: "Recover the wallet by combining lists of words together. These can be secured in different places for added security."
    },
    TR_SELECT_SEED_TYPE: {
    ...
    TR_CHECK_FINGERPRINT: {
        ...
        description: "This appears when updating some ancient firmwares. Fingerprint is cryptographic signature of the target firmware."
    },
    TR_ONBOARDING_NEW_FW_DESCRIPTION: {
        id: "TR_ONBOARDING_NEW_FW_DESCRIPTION",
        defaultMessage: "A new firmware version is available. You can also update your Trezor directly from Suite once you have finished setting up your device."
    },
    TR_FIRMWARE_NEW_FW_DESCRIPTION: {
        id: "TR_FIRMWARE_NEW_FW_DESCRIPTION",
        defaultMessage: "A new firmware version is available. You might either update your device now or continue and update it later."
    },
    ...
    LOG_INCLUDE_BALANCE_DESCRIPTION: {
        ...
        defaultMessage: "In case your issue does not relates to your balance or transactions, you may turn this off. Your account descriptors (XPubs) won't be included in copied log."
    },
    LOG_DESCRIPTION: {
        id: "LOG_DESCRIPTION",
        defaultMessage: "In case of a communication with our support team, there is a log with a lot of technical info"
    },
    ...
    TR_USING_EITHER_YOUR_SINGLE_BACKUP: {
        ...
        defaultMessage: "If you have a seed or Shamir backup of another wallet, you can choose to restore it"
    },
    TR_SELECT_DEVICE_STATUS: {
        id: "TR_SELECT_DEVICE_STATUS",
        defaultMessage: "Have you used this Trezor before?",
        description: "In onboarding, where user is choosing whether device is brand new or already used"
    },
    TR_YOU_CAN_SELECT_EITHER: {
        id: "TR_YOU_CAN_SELECT_EITHER",
        defaultMessage: "Are you using this Trezor for the first time or you have already used it before?"
    },
    ...
    TR_ONLY_2_MORE_STEPS: {
        ...
        defaultMessage: "However, if you aren't in a private location or you just want to test out Suite, you can skip this step."
    },
    TR_RECEIVED: {
        id: "TR_RECEIVED",
    ...
    BACKUP_BACKUP_ALREADY_FINISHED_DESCRIPTION: {
        ...
        defaultMessage: "Connected device as backup already finished. You should have a recovery seed written down and hidden in a safe place."
    },
    ...
    BACKUP_BACKUP_ALREADY_FAILED_DESCRIPTION: {
        ...
        defaultMessage: "A previous attempt to backup this device failed. Device backup may be done only once."
    },
    ...
    OP_RETURN_TOOLTIP: {
        ...
        defaultMessage: "Script opcode used to mark a transaction output as invalid. Since any outputs with OP_RETURN are provably unspendable, OP_RETURN outputs can be used to burn bitcoins."
    },
    OP_RETURN_ADD: {
        id: "OP_RETURN_ADD",
    ...
    RBF_TOOLTIP: {
        id: "RBF_TOOLTIP",
        defaultMessage: "Node policy that allows an unconfirmed transaction in a mempool to be replaced with a different transaction that spends at least one of the same inputs and which pays a higher transaction fee."
    },
    RBF_ON: {
        id: "RBF_ON",
    ...
    RBF_DESCRIPTION: {
        id: "RBF_DESCRIPTION",
        defaultMessage: "RBF allows to bump fee later in case you want the transaction to be mined faster."
    },
    LOCKTIME: {
        id: "LOCKTIME",
    ...
    LOCKTIME_SCHEDULE_SEND_TOOLTIP: {
        ...
        defaultMessage: "Locktime sets the earliest time or block height a transaction can be mined in to a block."
    },
    LOCKTIME_NOT_SET: {
        id: "LOCKTIME_NOT_SET",
    ...
    DESTINATION_TAG_TOOLTIP: {
        ...
        defaultMessage: "Destination tag is unique identification codes to identify the receiver of a transaction."
    },
    ...
    TR_YOUR_LABELING_IS_SYNCED: {
        defaultMessage: "Your labeling is synced with cloud storage provider. Your data are safe, only your Trezor can decrypt them.",
    ...
    TR_TO_MAKE_YOUR_LABELS_PERSISTENT: {
        defaultMessage: "To make your labels persistent and available on different devices connect to cloud storage provider.",
        id: "TR_TO_MAKE_YOUR_LABELS_PERSISTENT"
    },
    TR_DROPBOX: {
        defaultMessage: "Dropbox",
        id: "TR_DROPBOX",
        description: "Name of cloud provider. Intended to be translated only in languages that do not use latin script"
    },
    TR_GOOGLE_DRIVE: {
    ...
    METADATA_MODAL_DESCRIPTION: {
        defaultMessage: "Please select a cloud provider to save your labels to. Your data is encrypted by Trezor.",
        id: "METADATA_MODAL_DESCRIPTION"
    },
    TR_LABELING_FEATURE_ALLOWS: {
        id: "TR_LABELING_FEATURE_ALLOWS",
        defaultMessage: "Labeling allows you to rename your wallets, accounts, and addresses. Labels are applied by syncing with Dropbox or Google Drive."
    },
    TR_LABELING_ENABLED: {
    ...
    SETTINGS_ADV_COIN_BLOCKBOOK_DESCRIPTION: {
        ...
        defaultMessage: "Coins settings also defines the Discovery process when Trezor is connected, Each time you connect not remembered device."
    },
    ...
    SETTINGS_ADV_COIN_CONN_INFO_NO_CONNECTED: {
        ...
        defaultMessage: "Not connected to the backend yet. Try going to your account overview to establish the connection with the backend."
    },
    ...
    TR_GRAPH_MISSING_DATA: {
        ...
        defaultMessage: "XRP and ERC20 token transactions are included in the balance, but not currently supported in the graph view"
    },
    ...
    METADATA_PROVIDER_AUTH_ERROR: {
        ...
        defaultMessage: "Failed to sync labeling data with cloud provider {provider}. User was logged out."
    },
    ...
    TR_BACKUP_RECOVERY_SEED_FAILED_DESC: {
        ...
        defaultMessage: "The backup process has failed. It is highly recommended to back up your wallet. Please follow the link to learn how to successfully create recovery seed to back up your wallet."
    },
    TR_BACKUP_FAILED: {
        id: "BACKUP_FAILED",
        defaultMessage: "Backup failed"
    ...
    FIRMWARE_UPDATE_AVAILABLE_DESC: {
        ...
        defaultMessage: "We’re constantly working to improve your Trezor experience! Here’s a summary of what has changed:"
    },
    FIRMWARE_RECONNECT_BL_NEXT_STEP_DESC: {
        id: "FIRMWARE_RECONNECT_BL_NEXT_STEP_DESC",
        defaultMessage: "In the next step you will be asked to connect your device in bootloader mode."
    },
    FIRMWARE_RECONNECTED_BL_NEXT_STEP_DESC: {
        id: "FIRMWARE_RECONNECTED_BL_NEXT_STEP_DESC",
        defaultMessage: "In the next step, your Trezor will ask you to confirm this firmware update."
    },
    ...
    FIRMWARE_CONNECT_IN_NORMAL_MODEL_2: {
        ...
        defaultMessage: "Please make sure you are not holding any buttons while connecting your device."
    },
    ...
    TR_BACKUP_CHECKBOX_1_DESCRIPTION: {
        ...
        defaultMessage: "Make sure you recorded each word in the exact order it was given to you. Make sure your seed won't get wet or smudged."
    },
    ...
    TR_BACKUP_CHECKBOX_2_DESCRIPTION: {
        ...
        defaultMessage: "Don't save your seed in your phone or on any device that could be hacked, including a cloud service."
    },
    ...
    TR_BACKUP_CHECKBOX_3_DESCRIPTION: {
        ...
        defaultMessage: "Hide it well and use proper safeguards to ensure that you are the only person who ever sees your seed."
    },
    ...
    TR_SUITE_WEB_LANDING_BOTTOM_HEADLINE: {
        ...
        defaultMessage: "Dozens of <em>brand-new features</em> to discover.{lineBreak}Try Suite now."
    },
    ...
    TR_SUITE_WEB_LANDING_FEATURES_1_TEXT: {
        ...
        defaultMessage: "Enhanced security and privacy, new design and improved performance, all in one software suite."
    },
    ...
    TR_SUITE_WEB_LANDING_FEATURES_2_TEXT: {
        ...
        defaultMessage: "Compare competitive rates, buy, exchange and spend coins in Trezor's secure environment. Powered by Invity."
    },
    ...
    TR_SUITE_WEB_LANDING_FEATURES_3_TEXT: {
        ...
        defaultMessage: "ETH, XRP, ETC and more now supported directly through the app."
    },
    ...
    TR_DARK_MODE_DESCRIPTION: {
        ...
        defaultMessage: "This color scheme uses light-colored text, icons, and graphical user interface elements on a dark background."
    },
    TR_DEVICE_IS_IN_UNEXPECTED_MODE: {
        id: "TR_DEVICE_IS_IN_UNEXPECTED_MODE",
        defaultMessage: "Device is in unexpected mode. In the next step you will be asked to reconnect your device normally."
    },
    TR_EXPORT_AS: {
        id: "TR_EXPORT_AS",
    ...
    TR_TRANSACTIONS_SEARCH_TOOLTIP: {
        ...
        defaultMessage: "Search by transaction ID, label or amount or use operators such as < > | & = !=."
    },
    TR_TRANSACTIONS_SEARCH_TIP_1: {
        id: "TR_TRANSACTIONS_SEARCH_TIP_1",
        defaultMessage: "Tip: You can search for transaction IDs, addresses, labels, amounts and dates."
    },
    TR_TRANSACTIONS_SEARCH_TIP_2: {
        id: "TR_TRANSACTIONS_SEARCH_TIP_2",
        defaultMessage: "Tip: You can use the greater than (>) and lesser than (<) symbols on amount searches. For example <strong>> 1<strong> will show all transactions that have an amount of 1 or higher."
    },
    TR_TRANSACTIONS_SEARCH_TIP_3: {
        id: "TR_TRANSACTIONS_SEARCH_TIP_3",
        defaultMessage: "Tip: You can search for exact amounts using the equal (=) symbol. For example <strong>= 0.01</strong> will show only transactions that have an amount of exactly 0.01."
    },
    TR_TRANSACTIONS_SEARCH_TIP_4: {
        id: "TR_TRANSACTIONS_SEARCH_TIP_4",
        defaultMessage: "Tip: You can exclude an amount by using the exclamation mark and equal symbols together (!=). For example <strong>= -0.01</strong> will show all transactions except the ones with an amount of -0.01."
    },
    TR_TRANSACTIONS_SEARCH_TIP_5: {
        id: "TR_TRANSACTIONS_SEARCH_TIP_5",
        defaultMessage: "Tip: Dates can be searched using the <strong>YYYY-MM-DD</strong> format. For example <strong>2020-12-14</strong> will show all transactions on December 14th, 2020."
    },
    TR_TRANSACTIONS_SEARCH_TIP_6: {
        id: "TR_TRANSACTIONS_SEARCH_TIP_6",
        defaultMessage: "Tip: You can use greater than (>) and lesser than (<) symbols on date searches. For example <strong>> 2020-12-01<strong> will show all transactions on and after December 1st, 2020."
    },
    TR_TRANSACTIONS_SEARCH_TIP_7: {
        id: "TR_TRANSACTIONS_SEARCH_TIP_7",
        defaultMessage: "Tip: You can exclude a date by using the exlamation mark and equal symbols together (!=). For example <strong>!= 2020-12-14</strong> will show all transactions except the ones on December 14th, 2020."
    },
    TR_TRANSACTIONS_SEARCH_TIP_8: {
        id: "TR_TRANSACTIONS_SEARCH_TIP_8",
        defaultMessage: "Tip: You can display results matching at least one of multiple searches by grouping them with the OR operator (|). For example <strong>2020-12-31 | 2021-01-01</strong> will show all transactions that have happened on the 31st of December 2020 or 1st of January 2021."
    },
    TR_TRANSACTIONS_SEARCH_TIP_9: {
        id: "TR_TRANSACTIONS_SEARCH_TIP_9",
        defaultMessage: "Tip: You can display results matching multiple searches by grouping them with the AND operator (&). For example <strong>> 2020-12-01 & < 2020-12-31 & > 0</strong> will show all incoming (amount higher than 0) transactions in December 2020."
    },
    TR_TRANSACTIONS_SEARCH_TIP_10: {
        id: "TR_TRANSACTIONS_SEARCH_TIP_10",
        defaultMessage: "Tip: You can combine AND (&) and OR (|) operators for more complex searches. For example For example <strong>> 2020-12-01 & < 2020-12-31 | > 2020-12-01 & < 2020-12-31</strong> will show all all transactions in January 2020 or December 2020."
    },
    TR_PAGINATION_NEWER: {
    ...
    TR_SUITE_META_DESCRIPTION: {
        ...
        defaultMessage: "New desktop & browser app for Trezor hardware wallets. Trezor Suite brings big improvements across our three key pillars of usability, security and privacy."
    },
    ...
    TR_RUNNING_MULTIPLE_INSTANCES: {
        ...
        defaultMessage: "It seems you are running multiple instances of the app. If you are using Suite in other window or tab, close it and refresh the app."
    },
    ...
    TR_ONBOARDING_DEVICE_CHECK: {
        ...
        description: "Heading for an onboarding step where we ask the user to verify authenticity of his device"
    },
    ...
    TR_ONBOARDING_DEVICE_CHECK_4: {
        ...
        defaultMessage: "Firmware is already installed on the connected Trezor. Only continue with setup if you have used this Trezor before."
    },
    ...
    TR_ONBOARDING_COINS_STEP_DESCRIPTION: {
        ...
        defaultMessage: "Select cryptocurrencies to show in Trezor Suite. You can change this setting at any time. Some coins are ERC20 tokens and can be used by enabling Ethereum below."
    },
    ...
    TR_ONBOARDING_TROUBLESHOOTING_FAILED: {
        ...
        decription: "If troubleshooting steps for connecting a device in Onboarding didn't do the trick there is at the end link to contact a support"
    },
    ...
    TR_ONBOARDING_CUSTOM_BACKEND_DESCRIPTION: {
        ...
        defaultMessage: "You can set custom blockchain backend for Suite to fetch information from."
    },
    ...
    TR_TROUBLESHOOTING_TIP_BRIDGE_USE_TITLE: {
        ...
        defaultMessage: "If the above tips didn’t work, you can try using Trezor Bridge instead of WebUSB"
    },
    ...
    TR_TROUBLESHOOTING_TIP_UDEV_INSTALL_DESCRIPTION: {
        ...
        defaultMessage: "Try installing <a>udev rules</a>. Make sure to first save them to desktop before opening."
    },
    ...
    TR_TROUBLESHOOTING_CLOSE_TABS_DESCRIPTION_DESKTOP: {
        defaultMessage: "After closing other browser tabs and windows, try quitting and reopening the Trezor Suite app.",
    ...
    TR_TROUBLESHOOTING_TIP_CABLE_DESCRIPTION: {
        ...
        defaultMessage: "The cable must be fully inserted. If you have a Model T, the cable should \"click\" into place."
    },
    ...
    TR_SEEDLESS_SETUP_IS_NOT_SUPPORTED_DESCRIPTION: {
        ...
        defaultMessage: "Devices which are set up in the seedless mode cannot access the Trezor Suite. This is to avoid catastrophic coin loss, in case an inappropriately setup device is used for a wrong purpose."
    },
